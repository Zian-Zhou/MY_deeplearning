# -*- coding: utf-8 -*-
"""
Created on Sun Jul 22 15:13:11 2018
...
#%%==========================Part 1：Face Recognition for the Happy House
"""
...
In this exercise, we will be using a pre-trained model which represents ConvNet activations using a “channels first” convention, 
 ...
 In other words, a batch of images will be of shape(m,nC,nH,nW) instead of(m,nH,nW,nC). 
 Both of these conventions have a reasonable amount of traction among open-source implementations; 
 there isn’t a uniform standard yet within the deep learning community.
"""
